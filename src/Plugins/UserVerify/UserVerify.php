<?php
namespace HoltBosse\Alba\Plugins\UserVerify;
...
class UserVerify extends Plugin {
    ...
    public function send_email($email, $username, $key, $redirect) {
        ...
        $mail->subject = "Verify Your " . $_ENV["sitename"] . " Account";
        $mail->html = "<p>Hello, You have been registered for an account on " . $_ENV["sitename"] . "</p>";
                        ...
                        <tr>
                            ...
                            <td style=\"width: 500px; padding: 25px; background-color: white; border-radius: 0px;\">
                                ...
                                <div style=\"text-align: center;\">
                                    <a href=\"" . $site_domain . "\">
                                        <img src=\"" . $logo_src . "\" alt=\"" . $_ENV["sitename"] . " Logo\" style=\"width: 300px;\">
                                    </a>
                                </div>
                                <br>
                                <div style=\"text-align: left; font-weight: normal;\">
                                    ...
                                    <p>Your email was just used to register for an account with <a href=\"https://" . $_SERVER["SERVER_NAME"] . "\" style=\"color: " . $link_color . "\">" . $_ENV["sitename"] . '</a>. If this was you:</p>
                                    <br>
                                    <div style="text-align: center;">
                                    ...
                                    <br>
                                    <p>If you did not register for an " . $_ENV["sitename"] . " account <span style=\"font-weight: bold;\">do not</span> click the button above. Your email will not be associated with any account. No further action is needed.</p>
                                    <br>
                                    <br>
                                </div>
                            </th>
