	...
	public function display() {
		...
		?>
			<section class="editor_root_node">
				...
				<script type="module">
					import { Editor } from 'https://esm.sh/@tiptap/core@2.22.3'
					...
					import Superscript from 'https://esm.sh/@tiptap/extension-superscript@2.22.3'
					import Subscript from 'https://esm.sh/@tiptap/extension-subscript@2.22.3'
					//import TextStyle from 'https://esm.sh/@tiptap/extension-text-style@2.22.3'
					import Link from 'https://esm.sh/@tiptap/extension-link@2.22.3'
					import Youtube from 'https://esm.sh/@tiptap/extension-youtube@2.22.3'
					import Image from 'https://esm.sh/@tiptap/extension-image@2.22.3'
					...
					import Paragraph from 'https://esm.sh/@tiptap/extension-paragraph@2.22.3'
					import Heading from 'https://esm.sh/@tiptap/extension-heading@2.22.3'
					import BubbleMenu from 'https://esm.sh/@tiptap/extension-bubble-menu@2.22.3'
					import FileHandler from 'https://esm.sh/@tiptap/extension-file-handler@2.22.3'
					...
					const editorInstance = new Editor({
						...
						extensions: [
							...
							FileHandler.configure({
								allowedMimeTypes: <?php echo json_encode(array_keys(File::$image_types)); ?>,
								onPaste: (editor, files, htmlContent) => {
									console.log("hi form image paste");
								},
								onDrop: (editor, files, pos) => {
									console.log("hi form image drop");
								},
							})
						],
						editorProps: {
