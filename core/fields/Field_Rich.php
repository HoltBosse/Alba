			...
			document.addEventListener("DOMContentLoaded", function(){
				...
				document.querySelector('#editor_for_<?php echo $this->name;?>').addEventListener("paste", function(pasteEvent) {
					...
					if (!found_image) {
						...
						// todo: check for pasteEvent.clipboardData.types - then choose correct getData event
						// e.g. types contains text/html || text/plain - and handle accordingly in getData call
