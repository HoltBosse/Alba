...
class Field extends HoltBosse\Form\Field {
	public $content_type;
	...
	//as backwards compat, we leave this method defined so that old fields can define it
	//php code that calls this method will need to be updated, as we cant have each method calling the other as that will create loops
	//simple s/->load_from_config/->loadFromConfig
	public function load_from_config($config) {
		
	}

	//since the form library uses this method, we call it in inheritance stack to handle its field, and then the legacy method
