...
CMS::add_action("test_hook","test_action",1,1); // label, function, priority, arg count
...
CMS::add_action("content_ready","insert_current_year",1,1); // label, function, priority, arg count
