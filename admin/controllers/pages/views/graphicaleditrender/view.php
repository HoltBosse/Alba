    ...
    echo "<section id='graphicaleditrendersection'>";
        ?>
            <script>
                ...
                <?php echo file_get_contents(CMSPATH . "/admin/controllers/pages/views/graphicaleditrender/comandexec.js"); ?>
                <?php echo file_get_contents(CMSPATH . "/admin/controllers/pages/views/graphicaleditrender/script.js"); ?>
            </script>
            <style>
                <?php echo file_get_contents(CMSPATH . "/admin/controllers/pages/views/graphicaleditrender/style.css"); ?>
            </style>
            ...
            <!-- <br> -->
            <div class="graphicaledit_newwidget">
                <span class="graphicaledit_newwidget_span">  + new widget +  </span>
            </div>
        <?php
        CMS::jprint_r("test");
    echo "<section>";
